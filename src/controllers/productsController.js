    ...
    store: (req,res) => {
        ...
        if(req.file) {
            if(newProduct.category=="tablas de surf"){
              newProduct.image = "../../public/images/tablas-de-surf/"+ req.file.filename ;
            }else {newProduct.image = "../../public/images/Accesorios/"+ req.file.filename ;
             }
        } else { 
            if(newProduct.keels){
    ...
    update: (req, res) => {
        ...
        if(req.file) {
            ...
            if(productToEdit.category=="tablas de surf"){
                productToEdit.image = "../../public/images/tablas-de-surf/"+ req.file.filename ;
            }else {
                productToEdit.image = "../../public/images/Accesorios/"+ req.file.filename ;
             }
