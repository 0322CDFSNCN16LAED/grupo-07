...
function actualizarTotal() {
  let contenedorItemCarrito =
    document.getElementsByClassName("carrito-table")[0];
  let carritoFilas =
    contenedorItemCarrito.getElementsByClassName("carrito-item");
  let total = 0;
  for (let i = 0; i < carritoFilas.length; i++) {
    let carritoFila = carritoFilas[i];
    let elementoPrecio =
      carritoFila.getElementsByClassName("carrito-precio")[0];
